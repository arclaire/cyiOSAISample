...
- (id)initWithSessionPreset:(NSString *)sessionPreset cameraPosition:(AVCaptureDevicePosition)cameraPosition; 
{
    ...
    _inputCamera = [AVCaptureDevice defaultDeviceWithDeviceType:AVCaptureDeviceTypeBuiltInWideAngleCamera mediaType:AVMediaTypeVideo position:cameraPosition];
...
- (void)rotateCamera
{
    ...
    AVCaptureDevice *backFacingCamera = [AVCaptureDevice defaultDeviceWithDeviceType:AVCaptureDeviceTypeBuiltInWideAngleCamera mediaType:AVMediaTypeVideo position:currentCameraPosition];
...
- (BOOL)toggleTorch {
    ...
    if ([_inputCamera hasTorch]) {
        NSError *error = nil;
        
        if ([_inputCamera lockForConfiguration:&error]) {
            if ([_inputCamera isTorchActive]) {
